...
const DICT = {
  fr: {
    ...
    "dash.km.manual": "Saisie manuelle",
    "dash.km.scan": "Scanner le compteur",
    "dash.km.takePhoto": "Prendre une photo",
    "dash.km.choosePhoto": "Choisir une photo",
    "dash.km.scanning": "Lecture du compteur…",
    "dash.km.detected": "Kilométrage détecté",
    "dash.km.confirm": "Confirmer et mettre à jour",
    "dash.km.retake": "Reprendre",
    "dash.km.editDetected": "Vous pouvez ajuster la valeur si besoin",
    "dash.km.scanFailed": "Lecture impossible. Reprenez une photo plus nette.",
    "dash.km.tooLow": "La valeur doit être supérieure ou égale au kilométrage actuel",
    "dash.km.scanTitle": "Scanner le compteur kilométrique",
    "dash.km.scanHint": "Cadrez bien l'écran du compteur, sans reflet.",
  ...
  ar: {
    ...
    "dash.km.manual": "إدخال يدوي",
    "dash.km.scan": "مسح العداد",
    "dash.km.takePhoto": "التقاط صورة",
    "dash.km.choosePhoto": "اختيار صورة",
    "dash.km.scanning": "جارٍ قراءة العداد…",
    "dash.km.detected": "الكيلومترات المكتشفة",
    "dash.km.confirm": "تأكيد وتحديث",
    "dash.km.retake": "إعادة الالتقاط",
    "dash.km.editDetected": "يمكنك تعديل القيمة إذا لزم الأمر",
    "dash.km.scanFailed": "تعذرت القراءة. التقط صورة أوضح من فضلك.",
    "dash.km.tooLow": "يجب أن تكون القيمة أكبر أو تساوي الكيلومترات الحالية",
    "dash.km.scanTitle": "مسح عداد الكيلومترات",
    "dash.km.scanHint": "أَطّر شاشة العداد جيدًا دون انعكاسات.",
